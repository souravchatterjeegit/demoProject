...
describe('Author e2e test', () => {
  ...
  it('should load Authors', async () => {
    ...
    expect(await authorComponentsPage.getTitle()).to.eq('blogApp.author.home.title');
  });
  ...
  it('should load create Author page', async () => {
    ...
    expect(await authorUpdatePage.getPageTitle()).to.eq('blogApp.author.home.createOrEditLabel');
  ...
  it('should delete last Author', async () => {
    ...
    expect(await authorDeleteDialog.getDialogTitle()).to.eq('blogApp.author.delete.question');
